...
class Client extends CI_Controller
{
    ...
    public function event(){
        ...
        $dataReturn = array();
         //konfigurasi pagination
         $config['base_url'] = site_url('client/event/'); //site url
         $config['total_rows'] = count($this->Event_model->get_all()); //total row
         $config['per_page'] = 5;  //show record per halaman
         ...
         $data['data'] =  $this->Event_model->get_all_limit($config["per_page"], $data['page']);           
