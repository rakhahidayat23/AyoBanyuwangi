...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2019 at 07:18 AM
...
INSERT INTO `gallery` (`id`, `image`, `spot_id`, `type_gallery_id`) VALUES
(1, 'assets/upload/profile/gunung.jpeg', 1, 1),
(2, 'assets/upload/profile/gunung.jpeg', 1, 1),
(3, 'assets/upload/profile/Puncak-Sejati-Gunung-Raung-Wisata-Gunung-Banyuwangi.jpg', 2, 1);
...
INSERT INTO `news` (`id`, `id_spot`, `tanggal`, `judul`, `keterangan`) VALUES
(1, 1, '2019-03-28 00:00:00', 'Notification', 'Tutup di karenakan adanya perbaikan'),
(2, 1, '2019-03-28 00:00:00', 'Open Camp', 'Open ivent camp');
...
CREATE TABLE `spot` (
  ...
  `user_id` int(11) NOT NULL,
  `start` varchar(255) COLLATE utf8_danish_ci NOT NULL,
  `end` varchar(255) COLLATE utf8_danish_ci NOT NULL,
...
INSERT INTO `spot` (`id`, `name`, `description`, `latitude`, `longitude`, `date`, `type_spot_id`, `user_id`, `start`, `end`, `status`) VALUES
(1, 'Gunung Ijen', 'Gunung Ijen adalah sebuah gunung berapi aktif yang terletak di perbatasan antara Kabupaten Banyuwangi dan Kabupaten Bondowoso, Jawa Timur, Indonesia. Gunung ini memiliki ketinggian 2.443 mdpl dan terletak berdampingan dengan Gunung Merapi. Gunung Ijen terakhir meletus pada tahun 1999. Salah satu fenomena alam yang paling terkenal dari Gunung Ijen adalah kawah yang terletak di puncaknya. Pendakian gunung ini bisa dimulai dari beberapa tempat. Pendaki bisa berangkat dari Banyuwangi ataupun dari Bondowoso. ', '-8.0587807', '114.2352035', '2019-03-23 00:51:24', 1, 1, '07:00 am', '20:00 pm', 1),
(2, 'Gunung Raung', 'Gunung Ranti adalah gunung di Provinsi Jawa Timur, Indonesia. Gunung Ranti merupakan salah satu puncak di kawasan Pegunungan Ijen dengan ketinggian mencapai 2.601 Mdpl yang berada di perbatasan Kabupaten Bondowoso dan Kabupaten Banyuwangi. Gunung berbentuk kerucut ini terletak di sebelah baratdaya Gunung Merapi (Jawa Timur) dan Gunung Ijen.', '-7.587871', '110.450197', '2019-03-24 00:33:41', 1, 1, '07:00  am', '20:00 pm', 1);
...
INSERT INTO `user` (`id`, `name`, `username`, `password`, `email`, `phone`, `image`, `date`, `level_user_id`, `status`) VALUES
(1, 'lul ba', 'lul', '328cc988b604d8f67b9e8cd2abbc1d443cff1203', 'lul@lul.com', '0822574646455', 'assets/upload/profile/d4b0ef4e-475e-4d10-9d47-0217215754592.jpeg', '2019-03-22 12:36:11', 1, 1),
(2, 'test', 'root', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'xejefi@ace-mail.net', '82257464699', 'assets/upload/profile/d4b0ef4e-475e-4d10-9d47-0217215754592.jpeg', '2019-03-22 23:21:41', 3, 1);
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `news_ibfk_1` FOREIGN KEY (`id_spot`) REFERENCES `spot` (`id`);
